...
| **Org Admin** | — | Onboards a new org, sets org-level policy/skill/`IacSourceRef` defaults | Outside the 8-step flow — org registry onboarding, not yet built | Not built |
