...
def build_organization_onboarding_graph(
    *,
    ...
    builder.add_node("persist_identity_proof", build_persist_identity_proof(store))
    ...
    builder.add_conditional_edges(
        ...
        {"continue": "persist_identity_proof", "pending_review": "persist_identity_proof", "stop": END},
    )
    builder.add_conditional_edges(
        "persist_identity_proof", proof_succeeded,
